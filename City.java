...
public class City{
    ...
    public City(Random rand, int numMice, int numPoisonMice, int numCats, int numZombieCats) {
        this.rand = rand;
        ...
        for (int i=0; i<numPoisonMice; i++) addPoisonMouse();
    ...
    public void addPoisonMouse(){
        creaturesToAdd.add(new PoisonMouse(rand.nextInt(HEIGHT),rand.nextInt(WIDTH),this,rand));
    }
